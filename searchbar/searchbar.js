  ...
  inp.addEventListener("input", function(e) {
      ...
      for (i = 0; i < arr.length; i++) {
        ...
        if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
          ...
          b.innerHTML = "<div style=\"color: white; padding: 2px; background-color: black;\"><strong>" + arr[i].substr(0, val.length) + "</strong>" + arr[i].substr(val.length); + "</div>";
          // b.innerHTML += "<div style =\"color:white;\">" + arr[i].substr(val.length); + "</div>"
          /*insert a input field that will hold the current array item's value:*/
          b.innerHTML += "<div style=\"color: white; padding: 2px; background-color: black;\"><input type='hidden' value='" + arr[i] + "'></div>";
